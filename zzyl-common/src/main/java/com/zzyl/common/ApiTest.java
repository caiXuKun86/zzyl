...
//        System.out.println(result);
        ...
        OpenAIClient client = OpenAIOkHttpClient.builder()
                .apiKey("sk-d4fe6aa32e314d2d8fc261f6ef3307fb") //将your_APIKey替换为真实值，如何获取API Key请查看https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Um2wxbaps#步骤二-获取api-key
                .baseUrl("https://api.deepseek.com") //千帆ModelBuilder平台地址
                .build();

        ChatCompletionCreateParams params = ChatCompletionCreateParams.builder()
                .addUserMessage(content)
                .model("deepseek-chat") // 模型对应的model值，请查看支持的模型列表：https://cloud.baidu.com/doc/WENXINWORKSHOP/s/wm7ltcvgc
